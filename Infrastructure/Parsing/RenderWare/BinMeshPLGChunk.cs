...
{
    public uint Flags;
    private List<BinMeshPlgMesh> _meshes = null!;
    ...
    public override void Read(BinaryReader binaryReader)
    {
        // Print debug message
        Console.WriteLine(
            $"BinMeshPLGChunk.Read: Reading bin mesh PLG chunk at position: '{binaryReader.BaseStream.Position}'");
        ...
        // Print debug message
        Console.WriteLine(
            $"BinMeshPLGChunk.Read: Finished reading bin mesh PLG chunk at position: '{binaryReader.BaseStream.Position}'");
    }
