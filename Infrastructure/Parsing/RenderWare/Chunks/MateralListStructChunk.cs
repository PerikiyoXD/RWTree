...
public class MateralListStructChunk : Chunk
{
    ...
    public override void Read(BinaryReader binaryReader)
    {
        // Print debug message
        Console.WriteLine(
            $"MateralListStructChunk.Read: Reading material list struct chunk at position: '{binaryReader.BaseStream.Position}'");
        ...
        // Print debug message
        Console.WriteLine(
            $"MateralListStructChunk.Read: Read material list struct chunk up to position: '{binaryReader.BaseStream.Position}'");
    }
}