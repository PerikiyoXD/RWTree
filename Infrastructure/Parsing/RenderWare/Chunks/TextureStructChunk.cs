...
public class TextureStructChunk(TextureChunk? parent, ChunkHeader header) : Chunk(parent, header)
{
    ...
    public override void Read(BinaryReader binaryReader)
    {
        // Print debug message
        Console.WriteLine(
            $"TextureStructChunk.Read: Reading texture struct chunk at position: '{binaryReader.BaseStream.Position}'");
        ...
        // Print debug message
        Console.WriteLine(
            $"TextureStructChunk.Read: Read texture struct chunk up to position: '{binaryReader.BaseStream.Position}'");
    }
    ...
    public static TextureStructChunk? ReadTextureStruct(BinaryReader fileAccess, TextureChunk? parent)
    {
        ...
        {
            Console.WriteLine(
                $"TextureStructChunk.ReadTextureStruct: Expected chunk type '{ChunkType.Struct.ToString()}', but got '{header.Type}' at position: '{fileAccess.BaseStream.Position}'");
