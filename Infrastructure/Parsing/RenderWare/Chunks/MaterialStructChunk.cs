...
public class MaterialStructChunk(MaterialChunk? parent, ChunkHeader header) : Chunk(parent, header)
{
    ...
    public override void Read(BinaryReader binaryReader)
    {
        // Print debug message
        Console.WriteLine(
            $"MaterialStructChunk.Read: Reading material struct chunk at position: '{binaryReader.BaseStream.Position}'");
        ...
        // Print debug message
        Console.WriteLine(
            $"MaterialStructChunk.Read: Read material struct chunk up to position: '{binaryReader.BaseStream.Position}'");
    }
