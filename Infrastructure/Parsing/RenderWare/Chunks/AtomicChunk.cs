...
{
    public AtomicStructChunk AtomicStruct = null!;
    ...
    public override void Read(BinaryReader binaryReader)
    {
        ...
        // Read atomic struct
        AtomicStruct = AtomicStructChunk.ReadAtomicStruct(binaryReader, this); // Read extension
    ...
    protected override void AddChildChunks(ChunkNode node)
    {
        ...
        {
            var atomicStructNode = AtomicStruct.ToChunkNode();
            node.AddChild(atomicStructNode);
        }
