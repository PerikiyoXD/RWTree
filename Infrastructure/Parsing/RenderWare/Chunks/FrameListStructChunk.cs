...
public class FrameListStructChunk(FrameListChunk? parent, ChunkHeader header) : Chunk(parent, header)
{
    ...
    public override void Read(BinaryReader binaryReader)
    {
        // Print debug message
        Console.WriteLine(
            $"FrameListStructChunk.Read: Reading frame list struct chunk at position: '{binaryReader.BaseStream.Position}'");
        ...
        // Print debug message
        Console.WriteLine(
            $"FrameListStructChunk.Read: Read frame list struct chunk up to position: '{binaryReader.BaseStream.Position}'");
    }
