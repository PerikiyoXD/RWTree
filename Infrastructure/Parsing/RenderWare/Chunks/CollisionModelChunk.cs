...
public class CollisionModelChunk(Chunk? parent, ChunkHeader header) : Chunk(parent, header)
{
    ...
    {
        Console.WriteLine(
            $"CollisionModelChunk.Read: Reading collision model chunk at position: '{binaryReader.BaseStream.Position}'");
        ...
        {
            Console.WriteLine(
                "CollisionModelChunk.Read: Collision model chunk data is not implemented yet, skipping...");
        ...
        Console.WriteLine(
            $"CollisionModelChunk.Read: Read collision model chunk up to position: '{binaryReader.BaseStream.Position}'");
    }
}