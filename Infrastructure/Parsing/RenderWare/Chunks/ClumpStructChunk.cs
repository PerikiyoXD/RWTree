...
public class ClumpStructChunk(ClumpChunk? parent, ChunkHeader header) : Chunk(parent, header)
{
    ...
    public override void Read(BinaryReader binaryReader)
    {
        // Print debug message
        Console.WriteLine(
            $"ClumpChunk.StructData.Read: Reading clump struct at position: '{binaryReader.BaseStream.Position}'");
        ...
        // Print debug message
        Console.WriteLine(
            $"ClumpChunk.StructData.Read: Read clump struct up to position: '{binaryReader.BaseStream.Position}'");
    }
    ...
    public override void Write(BinaryWriter binaryWriter)
    {
        // Print debug message
        Console.WriteLine(
            $"ClumpChunk.StructData.Write: Writing clump struct at position: '{binaryWriter.BaseStream.Position}'");
        ...
        // Print debug message
        Console.WriteLine(
            $"ClumpChunk.StructData.Write: Wrote clump struct up to position: '{binaryWriter.BaseStream.Position}'");
    }
