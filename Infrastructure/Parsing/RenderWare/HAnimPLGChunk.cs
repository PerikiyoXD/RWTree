...
public class HAnimPlgChunk(Chunk? parent, ChunkHeader header) : Chunk(parent, header)
{
    ...
    public override void Read(BinaryReader binaryReader)
    {
        // Print debug message
        Console.WriteLine(
            $"HAnimPLGChunk.Read: Reading HAnimPLG chunk at position: '{binaryReader.BaseStream.Position}'");
        ...
        // Print debug message
        Console.WriteLine(
            $"HAnimPLGChunk.Read: Read HAnimPLG chunk up to position: '{binaryReader.BaseStream.Position}'");
    }
